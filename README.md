    ...
    interactions = {
      {
        ...
        spawns = {
          ...
          vector4(407.65, -984.40, 29.27, 52.90)
        }
      }
    },
    divisions = {
      {
        ...
        vehicles = {
          {
            model = "nn21hoe", name = "2021 Tahoe",
            extras = { 4, 8, 9, 11 }, livery = 0,
            mods = { [27] = 0, [28] = 0, [42] = 0 },
            primaryColor = 0, secondaryColor = 0, windowTint = 0, dirtLevel = 0.0
          },
          {
            model = "nn25fpiu", name = "2025 FPIU",
            stations = { "MissionRow" }, plateFormat = 'LL NN L ',
            extras = { 4, 8, 9, 11 }, livery = 0
          }
        }
      },
      {
        label = "Traffic",
        vehicles = {
          { model = "police3", name = "Traffic Interceptor", livery = 2, stations = { "DelPerro" } }
        }
      }
    }
  }
